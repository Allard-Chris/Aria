...
// clang-format on
static const u64 c1[2] = {0x517cc1b727220a94, 0xfe12abe8fa9a6ee0};

static const u64 c2[2] = {0x6db14acc9e21c820, 0xff28b1d5ef5de2b0};

static const u64 c3[2] = {0xdb92371d2126e970, 0x0324977504e8c90e};
