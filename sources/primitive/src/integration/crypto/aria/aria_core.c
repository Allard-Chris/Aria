...
#define SBOX1 aria_SBOX[0]
#define SBOX2 aria_SBOX[1]
#define SBOX1INV aria_SBOX[2]
#define SBOX2INV aria_SBOX[3]
#define C1 aria_const[0]
#define C2 aria_const[1]
#define C3 aria_const[2]

// clang-format off
static const u8 aria_SBOX[][256] = {
    /* S1 */
...
static const u8 aria_const[][ARIA_BLOCK_SIZE] = {
  /* constant C1 */
{
  0x51, 0x7c, 0xc1, 0xb7,
  0x27, 0x22, 0x0a, 0x94,
...
27 sources/libressl-2.9.0/crypto/aria/aria_locl.h
@@ -0,0 +1,27 @@
/*********************************************
Author  : Chris Allard, Corentin Aulagnier
Date    : 2019-02
...
1 sources/libressl-2.9.0/include/openssl/Makefile.am
@@ -4,6 +4,7 @@ opensslincludedir=$(includedir)/openssl
...
8 sources/libressl-2.9.0/include/openssl/Makefile.in
@@ -111,11 +111,11 @@ am__v_P_1 = :
...
@@ -297,12 +297,12 @@ target_alias = @target_alias@
...
opensslinclude_HEADERS = aes.h aria.h asn1.h asn1t.h bio.h blowfish.h bn.h \
...
44 sources/libressl-2.9.0/include/openssl/aria.h
@@ -0,0 +1,44 @@
/*********************************************
Author  : Chris Allard, Corentin Aulagnier
Date    : 2019-02
