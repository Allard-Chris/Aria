...
BLOCK_CIPHER_func_cbc(aria_192, Aria, EVP_ARIA_KEY, ks)
BLOCK_CIPHER_func_cbc(aria_256, Aria, EVP_ARIA_KEY, ks)
BLOCK_CIPHER_func_ecb(aria_128, Aria, EVP_ARIA_KEY, ks)
BLOCK_CIPHER_func_ecb(aria_192, Aria, EVP_ARIA_KEY, ks)
BLOCK_CIPHER_func_ecb(aria_256, Aria, EVP_ARIA_KEY, ks)
...
BLOCK_CIPHER_def_cbc(aria_192, EVP_ARIA_KEY, NID_aria_192, 16, 24, 16, 0, Aria_init_key, NULL, EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, NULL)
BLOCK_CIPHER_def_cbc(aria_256, EVP_ARIA_KEY, NID_aria_256, 16, 32, 16, 0, Aria_init_key, NULL, EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, NULL)
...
BLOCK_CIPHER_def_ecb(aria_192, EVP_ARIA_KEY, NID_aria_128, 16, 24, 0, Aria_init_key, NULL, EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, NULL)
BLOCK_CIPHER_def_ecb(aria_256, EVP_ARIA_KEY, NID_aria_128, 16, 32, 0, Aria_init_key, NULL, EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, NULL)
